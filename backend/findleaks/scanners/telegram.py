...
class TelegramScanner(BaseScanner):
    ...
    async def scan_post(self, post_text: str, post_id: str) -> Optional[dict]:
        ...
        logger.info("telegram_leak_detected", post_id=post_id, exam=self.exam_slug, confidence=conf)
        ...
        return {"platform": "telegram", "post_id": post_id, "confidence": conf, "label": label}
